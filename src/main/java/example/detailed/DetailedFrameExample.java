...
public class DetailedFrameExample extends JFrame {
  ...
  public static void main(String [] args) {
    ...
    // frame.
    final DetailedFrameExample frame = new DetailedFrameExample(osrEnabledArg, cookiePath, args);
  ...
  public DetailedFrameExample(boolean osrEnabled, String cookiePath, String [] args) {
    ...
    menuBar.addBookmark("Binding Test", "client://example/binding_test.html");
    menuBar.addBookmark("Binding Test 2", "client://example/binding_test2.html");
    ...
    menuBar.addBookmark("Scheme-Handler Test 1: (scheme \"client\")", "client://example/handler.html");
    menuBar.addBookmark("Scheme-Handler Test 2: (scheme \"search\")", "search://do a barrel roll/");
    menuBar.addBookmark("Spellcheck test", "client://example/spellcheck.html");
    menuBar.addBookmark("Test local Storage", "client://example/localstorage.html");
