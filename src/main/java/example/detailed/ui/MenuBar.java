...
import example.detailed.dialog.CookieManagerDialog;
import example.detailed.dialog.DevToolsDialog;
import example.detailed.dialog.DownloadDialog;
import example.detailed.dialog.SearchDialog;
import example.detailed.dialog.ShowTextDialog;
import example.detailed.dialog.UrlRequestDialog;
import example.detailed.dialog.WebPluginManagerDialog;
    ...
    showForm.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        String form = "<html><head><title>RequestHandler test</title></head>";
               ...
               form+= "<p>See implementation of <u>example.RequestHandler.onBeforeBrowse(CefBrowser, CefRequest, boolean)</u> for details</p>";
               ...
               form+= "<p>See implementation of <u>example.RequestHandler.onBeforeResourceLoad(CefBrowser, CefRequest)</u> for details</p>";
               form+= "</form>";
               form+="</body></html>";
